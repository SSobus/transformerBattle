...
class RankBattleStrategyTest {

    @Test
    void shouldWinByRankAutobot() {
        Transformer autobot = initializeTransformer("Optimus Prime", TransformerType.AUTOBOT, 1, 1, 1, 1, 5, 1, 1);
        Transformer decepticon = initializeTransformer("Loser", TransformerType.DECEPTICON, 1, 1, 1, 1, 1, 1, 1);

        RankBattleStrategy strategy = new RankBattleStrategy();
    ...
    @Test
    void shouldWinByRankDecepticon() {
        Transformer autobot = initializeTransformer("Loser", TransformerType.AUTOBOT, 1, 1, 1, 1, 1, 1, 1);
        Transformer decepticon = initializeTransformer("Predaking", TransformerType.DECEPTICON, 1, 1, 1, 1, 5, 1, 1);
    ...
    @Test
    void shouldBeRankNotApplicable() {
